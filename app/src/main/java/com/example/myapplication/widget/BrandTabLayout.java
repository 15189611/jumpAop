...
public class BrandTabLayout extends HorizontalScrollView {
    ...
    private static final Pools.Pool<BrandTabLayout.Tab> tabPool = new Pools.SynchronizedPool<>(16);
    ...
    /**
     * If a tab is instantiated with {@link TabLayout.Tab#setText(CharSequence)}, and this mode is set, the text
     * will be saved and utilized for the content description, but no visible labels will be created.
     *
     * @see TabLayout.Tab#setTabLabelVisibility(int)
     */
    public static final int TAB_LABEL_VISIBILITY_UNLABELED = 0;

    /**
     * This mode is set by default. If a tab is instantiated with {@link TabLayout.Tab#setText(CharSequence)}, a
    ...
    public interface OnTabSelectedListener extends BrandTabLayout.BaseOnTabSelectedListener<BrandTabLayout.Tab> {}

    /**
     * Callback interface invoked when a tab's selection state changes.
     *
     * @deprecated Use {@link TabLayout.OnTabSelectedListener} instead.
     */
    @Deprecated
    public interface BaseOnTabSelectedListener<T extends BrandTabLayout.Tab> {
        /**
    ...
    @BrandTabLayout.TabGravity
    int tabGravity;
    int tabIndicatorAnimationDuration;
    @BrandTabLayout.TabIndicatorGravity
    ...
    @Nullable private BrandTabLayout.BaseOnTabSelectedListener selectedListener;

    private final ArrayList<BrandTabLayout.BaseOnTabSelectedListener> selectedListeners = new ArrayList<>();
    @Nullable private BrandTabLayout.BaseOnTabSelectedListener currentVpSelectedListener;
    ...
    private BrandTabLayout.TabLayoutOnPageChangeListener pageChangeListener;
    private BrandTabLayout.AdapterChangeListener adapterChangeListener;
    private boolean setupViewPagerImplicitly;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<TabView> tabViewPool = new Pools.SimplePool<>(12);

    public BrandTabLayout(@NonNull Context context) {
        this(context, null);
    }

    public BrandTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.tabStyle);
    }

    @SuppressLint("RestrictedApi")
    public BrandTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        tabIconTintMode =
                com.google.android.material.internal.ViewUtils.parseTintMode(a.getInt(R.styleable.TabLayout_tabIconTintMode, -1), null);
     ...
     */
    public void addTab(@NonNull BrandTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull BrandTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull BrandTabLayout.Tab tab, boolean setSelected) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull BrandTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.parent != this) {
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final BrandTabLayout.Tab tab = newTab();
        if (item.text != null) {
    ...
    @Deprecated
    public void setOnTabSelectedListener(@Nullable BrandTabLayout.OnTabSelectedListener listener) {
        setOnTabSelectedListener((BrandTabLayout.BaseOnTabSelectedListener) listener);
    }


    @Deprecated
    public void setOnTabSelectedListener(@Nullable BrandTabLayout.BaseOnTabSelectedListener listener) {
    ...
    public void addOnTabSelectedListener(@NonNull BrandTabLayout.OnTabSelectedListener listener) {
        addOnTabSelectedListener((BrandTabLayout.BaseOnTabSelectedListener) listener);
    }


    @Deprecated
    public void addOnTabSelectedListener(@Nullable BrandTabLayout.BaseOnTabSelectedListener listener) {
    ...
    public void removeOnTabSelectedListener(@NonNull BrandTabLayout.OnTabSelectedListener listener) {
        removeOnTabSelectedListener((BrandTabLayout.BaseOnTabSelectedListener) listener);
    }


    @Deprecated
    public void removeOnTabSelectedListener(@Nullable BrandTabLayout.BaseOnTabSelectedListener listener) {
    ...
    /**
     * Create and return a new {@link TabLayout.Tab}. You need to manually add this using {@link #addTab(TabLayout.Tab)}
     * or a related method.
     *
     * @return A new Tab
     */
    @NonNull
    public BrandTabLayout.Tab newTab() {
        BrandTabLayout.Tab tab = createTabFromPool();
        tab.parent = this;
    ...
    protected BrandTabLayout.Tab createTabFromPool() {
        BrandTabLayout.Tab tab = tabPool.acquire();
        if (tab == null) {
            tab = new BrandTabLayout.Tab();
        }
        return tab;
    }

    // TODO(b/76413401): remove this method and just create the final field after the widget migration
    protected boolean releaseFromTabPool(BrandTabLayout.Tab tab) {
    ...
    @Nullable
    public BrandTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(@NonNull BrandTabLayout.Tab tab) {
        if (tab.parent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final BrandTabLayout.Tab removedTab = tabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<BrandTabLayout.Tab> i = tabs.iterator(); i.hasNext(); ) {
            final BrandTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
     ...
     */
    public void setTabMode(@BrandTabLayout.Mode int mode) {
        if (mode != this.mode) {
            this.mode = mode;
            applyModeAndGravity();
        }
     ...
     */
    public void setTabGravity(@BrandTabLayout.TabGravity int gravity) {
     ...
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabIndicatorGravity
     */
    public void setSelectedTabIndicatorGravity(@BrandTabLayout.TabIndicatorGravity int indicatorGravity) {
    ...
    public void setInlineLabel(boolean inline) {
        if (inlineLabel != inline) {
            ...
            for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
                ...
                if (child instanceof BrandTabLayout.TabView) {
                    ((BrandTabLayout.TabView) child).updateOrientation();
                }
            }
            applyModeAndGravity();
        }
    ...
    public void setUnboundedRipple(boolean unboundedRipple) {
        if (this.unboundedRipple != unboundedRipple) {
            ...
            for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
                View child = slidingTabIndicator.getChildAt(i);
                if (child instanceof BrandTabLayout.TabView) {
                    ((BrandTabLayout.TabView) child).updateBackgroundDrawable(getContext());
                }
            }
        }
    }
    ...
    private void setupWithViewPager(
        ...
        if (viewPager != null) {
            ...
            if (pageChangeListener == null) {
                pageChangeListener = new BrandTabLayout.TabLayoutOnPageChangeListener(this);
            }
            pageChangeListener.reset();
            viewPager.addOnPageChangeListener(pageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            currentVpSelectedListener = new BrandTabLayout.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (adapterChangeListener == null) {
                adapterChangeListener = new BrandTabLayout.AdapterChangeListener();
            }
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (pagerAdapterObserver == null) {
                pagerAdapterObserver = new BrandTabLayout.PagerAdapterObserver();
            }
    ...
    @NonNull
    private BrandTabLayout.TabView createTabView(@NonNull final BrandTabLayout.Tab tab) {
        BrandTabLayout.TabView tabView = tabViewPool != null ? tabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new BrandTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(@NonNull BrandTabLayout.Tab tab, int position) {
    ...
    private void addTabView(@NonNull BrandTabLayout.Tab tab) {
        final BrandTabLayout.TabView tabView = tab.view;
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        for (int i = 0; i < slidingTabIndicator.getChildCount(); i++) {
            ...
            if (tabView instanceof BrandTabLayout.TabView) {
                ((BrandTabLayout.TabView) tabView).drawBackground(canvas);
            }
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // height
        final int idealHeight = Math.round(com.example.myapplication.widget.ViewUtils.dpToPx(getContext(), getDefaultHeight()));
        ...
        if (MeasureSpec.getMode(widthMeasureSpec) != MeasureSpec.UNSPECIFIED) {
            ...
            tabMaxWidth =
                    requestedTabMaxWidth > 0
                            ? requestedTabMaxWidth
                            : (int) (specWidth - com.example.myapplication.widget.ViewUtils.dpToPx(getContext(), TAB_MIN_WIDTH_MARGIN));
        }
    ...
    private void removeTabViewAt(int position) {
        final BrandTabLayout.TabView view = (BrandTabLayout.TabView) slidingTabIndicator.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == BrandTabLayout.Tab.INVALID_POSITION) {
            return;
        }
     ...
     */
    public void selectTab(@Nullable BrandTabLayout.Tab tab) {
        selectTab(tab, true);
    }
     ...
     *
     */
    public void selectTab(@Nullable final BrandTabLayout.Tab tab, boolean updateIndicator) {
        final BrandTabLayout.Tab currentTab = selectedTab;
    ...
    private void dispatchTabSelected(@NonNull final BrandTabLayout.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
            selectedListeners.get(i).onTabSelected(tab);
        }
    }

    private void dispatchTabUnselected(@NonNull final BrandTabLayout.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
            selectedListeners.get(i).onTabUnselected(tab);
        }
    }

    private void dispatchTabReselected(@NonNull final BrandTabLayout.Tab tab) {
        for (int i = selectedListeners.size() - 1; i >= 0; i--) {
    ...
    public static class Tab {
        ...
        @Nullable public BrandTabLayout parent;
        // TODO(b/76413401): make package private after the widget migration is finished
        @NonNull public BrandTabLayout.TabView view;
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setTag(@Nullable Object tag) {
            this.tag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setId(int id) {
            this.id = id;
            if (view != null) {
                view.setId(id);
            }
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setCustomView(@Nullable View view) {
            customView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setIcon(@Nullable Drawable icon) {
            this.icon = icon;
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (parent == null) {
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setText(@Nullable CharSequence text) {
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setText(@StringRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setTabLabelVisibility(@LabelVisibility int mode) {
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public BrandTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    /** A {@link LinearLayout} containing {@link TabLayout.Tab} instances for use with {@link TabLayout}. */
    public final class TabView extends LinearLayout {
        private BrandTabLayout.Tab tab;
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                BrandTabLayout.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
            }
        }
        ...
        void setTab(@Nullable final BrandTabLayout.Tab tab) {
            if (tab != this.tab) {
                this.tab = tab;
                update();
            }
        ...
        final void update() {
            final BrandTabLayout.Tab tab = this.tab;
        ...
        private void updateTextAndIcon(
            ...
            if (iconView != null) {
                ...
                if (hasText && iconView.getVisibility() == VISIBLE) {
                    ...
                    iconMargin = (int) com.example.myapplication.widget.ViewUtils.dpToPx(getContext(), DEFAULT_GAP_TEXT_ICON);
                }
                if (inlineLabel) {
        ...
        @Nullable
        public BrandTabLayout.Tab getTab() {
            return tab;
        }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
            ...
            if ((tabGravity == GRAVITY_CENTER) || mode == MODE_AUTO) {
                ...
                final int gutter = (int) com.example.myapplication.widget.ViewUtils.dpToPx(getContext(), FIXED_WRAP_GUTTER_MIN);
                boolean remeasure = false;
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (!tabIndicatorFullWidth && selectedTitle instanceof BrandTabLayout.TabView) {
                    calculateTabViewContentBounds((BrandTabLayout.TabView) selectedTitle, tabViewContentBounds);
                ...
                if (selectionOffset > 0f && selectedPosition < getChildCount() - 1) {
                    ...
                    if (!tabIndicatorFullWidth && nextTitle instanceof BrandTabLayout.TabView) {
                        calculateTabViewContentBounds((BrandTabLayout.TabView) nextTitle, tabViewContentBounds);
        ...
        private void updateOrRecreateIndicatorAnimation(
            ...
            if (!tabIndicatorFullWidth && targetView instanceof BrandTabLayout.TabView) {
                calculateTabViewContentBounds((BrandTabLayout.TabView) targetView, tabViewContentBounds);
                    ...
                    new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
                            ...
                            setIndicatorPosition(
                                    com.example.myapplication.widget.AnimationUtils.lerp(animationStartLeft, finalTargetLeft, fraction),
                                    com.example.myapplication.widget.AnimationUtils.lerp(animationStartRight, finalTargetRight, fraction));
                        }
                    };
        ...
        /**
         * Given a {@link TabLayout.TabView}, calculate the left and right bounds of its content.
         *
        ...
        private void calculateTabViewContentBounds(
                @NonNull BrandTabLayout.TabView tabView, @NonNull RectF contentBounds) {
            int tabViewContentWidth = tabView.getContentWidth();
            int minIndicatorWidth = (int) com.example.myapplication.widget.ViewUtils.dpToPx(getContext(), MIN_INDICATOR_WIDTH);
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = tabs.size(); i < count; i++) {
            BrandTabLayout.Tab tab = tabs.get(i);
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull private final WeakReference<BrandTabLayout> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        public TabLayoutOnPageChangeListener(BrandTabLayout tabLayout) {
        ...
        public void onPageScrolled(
            ...
            final BrandTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
     ...
     */
    public static class ViewPagerOnTabSelectedListener implements BrandTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(@NonNull BrandTabLayout.Tab tab) {
            viewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(BrandTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(BrandTabLayout.Tab tab) {
            // No-op
        }
    }
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (BrandTabLayout.this.viewPager == viewPager) {
