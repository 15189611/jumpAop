...
public class LeakDialogFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mShowsDialog = (int) getFiled("mContainerId") == 0;
    ...
    private Object getFiled(String fileName) {
        Class<?> superclass = this.getClass().getSuperclass();
        Object object = null;
        try {
            Field declaredField = Objects.requireNonNull(superclass).getDeclaredField(fileName);
            declaredField.setAccessible(true);
            object = declaredField.get(this);
        } catch (NoSuchFieldException e) {
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        }
        Log.e("Charles", "打印值==" + object);
        return object;
    }
